...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHoder> {
    ...
    static class MessageViewHoder extends RecyclerView.ViewHolder {
